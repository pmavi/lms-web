...
export default function IntermediateAssets({classes, data, onRowSelect}) {
         ...
         return [
            {
               ...
               Footer: <TypographyFHG className={classes.footerStyle} color={'primary'} variant={'h6'} id={'loan.intermediateLoanValue.column'}/>,
            }, {
   ...
   return (
      <LoanAnalysisTable name={'Intermediate Assets'} classes={classes} data={data?.categories} columns={columns} onSelect={onRowSelect}/>
   );
}

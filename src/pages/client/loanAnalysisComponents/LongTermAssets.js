...
export default function LongTermAssets({classes, data, onRowSelect}) {
         ...
         return [
            {
               ...
               Footer: <TypographyFHG className={classes.footerStyle} color={'primary'} variant={'h6'} id={'loan.longTermLoanValue.column'}/>,
            }, {
   ...
   return (
      <LoanAnalysisTable name={'Long Term Assets'} classes={classes} data={data?.categories} columns={columns} onSelect={onRowSelect}/>
   );
}

...
export default function LongTermLiabilities({classes, data, onRowSelect}) {
         ...
         return [
            {
               ...
               Footer: <TypographyFHG className={classes.footerStyle} color={'primary'} variant={'h6'} id={'loan.longTermLiabilities.label'}/>,
            }, {
   ...
   return (
      <LoanAnalysisTable name={'Long Term Liabilities'} classes={classes} data={data?.categories} columns={columns} onSelect={onRowSelect}/>
   );
}
